...
Proton = modules['Proton']._introspection_module
__all__ = []
...
Proton.critical = critical
Proton.debug = debug
Proton.info = info
Proton.message = message
Proton.warning = warning
