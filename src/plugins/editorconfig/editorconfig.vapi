[CCode (cprefix = "editorconfig_", lower_case_cprefix = "editorconfig_",
    cheader_filename = "editorconfig/editorconfig.h")]
namespace EditorConfig {
    [CCode (cname = "editorconfig_handle",
        free_function = "editorconfig_handle_destroy")]
    [Compact]
    public class Handle {
        ...
        public void get_name_value (
            int n, out unowned string? name, out unowned string? value);
